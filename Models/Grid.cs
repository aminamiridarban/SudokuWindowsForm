...
namespace SudokuInterViewCaseStudy.Models
{
    /// <summary>
    /// Grid of the Sudoku
    /// </summary>
    public class Grid 
    {
        ...
        /// <summary>
        /// The Filled Cells Property
        /// </summary>
        /// <returns>List of Filled Cells</returns>
        public List<int> FilledCells { get => Cells.FindAll(cell => cell.Value != -1).Select(cell => cell.Index).ToList(); }
        /// <summary>
        /// The Pre Filled Cells Property
        /// </summary>
        /// <returns>List of Filled Cells</returns>
        public List<int> PreFilledCells { get; set; }
        /// <summary>
        /// The Solver
        /// </summary>
